...
export default function ProductsPage() {
  ...
  async function fetchProducts() {
    try {
      ...
      if (!store) {
        setErrorMessage("Create a store before managing products.");
        setLoading(false);
        return;
      }
    ...
    <main className="p-8">
      <div className="flex items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/products/new"
            className="bg-pink-600 hover:bg-pink-700 text-white px-5 py-3 rounded-xl font-semibold"
          >
            + Add Product
          </Link>
        </div>
      ...
      {products.length === 0 ? (
        <div className="bg-white rounded-2xl shadow p-12 text-center">
          ...
          <Link
            href="/products/new"
            className="inline-block mt-4 bg-pink-600 text-white px-6 py-3 rounded-xl"
          >
            Create Product
          </Link>
        </div>
              ...
              <div className="p-5">
                ...
                <div className="flex gap-3 mt-6">
                  <Link
                    ...
                    className="flex-1 text-center bg-gray-100 rounded-xl py-2 hover:bg-gray-200"
                  >
                    Edit
                  </Link>
